...
$guards = @(
  ".\tools\chat-master\chat-master-panels-component-guard.ps1",
  ".\tools\chat-master\chat-master-owner-console-normalization-guard.ps1",
  ...
  ".\tools\chat-master\chat-master-diagnostics-ui-guard.ps1",
  ".\tools\chat-master\chat-master-confidence-diagnostics-guard.ps1",
  ".\tools\chat-master\chat-master-readiness-ui-guard.ps1"
)
