...
$required = @(
  ...
  @{ name = "learning weight strategy helper exists"; ok = $weightStrategyText -like "*buildLearningWeightDrivenStrategy*" },
  @{ name = "learning weight strategy posture exists"; ok = $weightStrategyText -like "*orchestration_posture*" },
