...
if ($Combined -notmatch '3b\.2') {
  throw "Phase 3B build process version 3b.2 not found"
}

if ($Combined -match '3b\.1') {
  throw "Old Phase 3B build process version 3b.1 still present"
}
