...
export const metadata: Metadata = {
    alternates: { canonical: "/oi/oi-framework-checklist" },
  openGraph: { url: "https://optinodeiq.com/oi/oi-framework-checklist" },
    ...
    <main className="mx-auto max-w-5xl px-6 py-12">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-bold tracking-tight">Optimized Intelligence Framework Checklist</h1>
          <p className="mt-3 text-white/75 max-w-3xl">A practical checklist for applying the Optimized Intelligence (OI) framework across any decision domain.</p>
        </div>
