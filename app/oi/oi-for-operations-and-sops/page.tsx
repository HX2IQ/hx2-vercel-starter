...
export const metadata: Metadata = {
  title: "OI for Operations and SOPs | Optinode",
  description: "Use Optimized Intelligence (OI) to build SOPs that work: verified steps, quality gates, exception handling, and continuous improvement.",
  alternates: { canonical: "/oi/oi-for-operations-and-sops" },
  openGraph: { url: "https://optinodeiq.com/oi/oi-for-operations-and-sops" },
};
  ...
  return (
    <main className="mx-auto max-w-6xl px-5 py-14 md:py-16">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-7 md:p-10 shadow-xl shadow-black/40">
        ...
        <h1 className="mt-2 text-4xl md:text-5xl font-black tracking-tight">OI for Operations and SOPs</h1>
        <p className="mt-4 text-white/80 leading-relaxed max-w-3xl">Most SOPs fail because they’re just documentation. OI turns SOPs into an operating system: steps + checks + thresholds + exception paths.</p>
        ...
        <Section title="What makes an OI SOP">
          <ul className="list-disc pl-5 space-y-2">
            <li>Inputs and prerequisites are explicit</li>
            <li>Quality gates prevent defects</li>
            <li>Exceptions are handled (not ignored)</li>
            <li>Metrics close the loop</li>
          </ul>
        </Section>
        <Section title="Where it works best">
          <ul className="list-disc pl-5 space-y-2">
            <li>Order fulfillment</li>
            <li>Customer service</li>
            <li>Onboarding</li>
            <li>QA and compliance</li>
          </ul>
        </Section>
