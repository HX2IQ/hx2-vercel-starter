...
export const metadata: Metadata = {
    alternates: { canonical: "/oi/oi-for-business-decisions" },
  openGraph: { url: "https://optinodeiq.com/oi/oi-for-business-decisions" },
    ...
    <main className="mx-auto max-w-5xl px-6 py-12">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-bold tracking-tight">Optimized Intelligence for Business Decisions</h1>
          <p className="mt-3 text-white/75 max-w-3xl">How businesses use Optimized Intelligence (OI) to reduce noise, verify signals, and make consistent, outcome-driven decisions.</p>
        </div>
