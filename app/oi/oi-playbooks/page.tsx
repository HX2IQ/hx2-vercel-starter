...
export const metadata: Metadata = {
    alternates: { canonical: "/oi/oi-playbooks" },
  openGraph: { url: "https://optinodeiq.com/oi/oi-playbooks" },
    ...
    <main className="mx-auto max-w-5xl px-6 py-12">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-bold tracking-tight">Optimized Intelligence Playbooks</h1>
          <p className="mt-3 text-white/75 max-w-3xl">Reusable Optimized Intelligence (OI) playbooks that turn decisions into repeatable operating systems.</p>
        </div>
