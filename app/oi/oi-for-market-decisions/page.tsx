...
export const metadata: Metadata = {
    alternates: { canonical: "/oi/oi-for-market-decisions" },
  openGraph: { url: "https://optinodeiq.com/oi/oi-for-market-decisions" },
    ...
    <main className="mx-auto max-w-5xl px-6 py-12">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-bold tracking-tight">Optimized Intelligence for Market Decisions</h1>
          <p className="mt-3 text-white/75 max-w-3xl">Apply Optimized Intelligence (OI) to markets using signal verification, decision flows, and risk-controlled execution.</p>
        </div>
