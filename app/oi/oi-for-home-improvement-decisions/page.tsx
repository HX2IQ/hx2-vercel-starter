...
export const metadata: Metadata = {
    alternates: { canonical: "/oi/oi-for-home-improvement-decisions" },
  openGraph: { url: "https://optinodeiq.com/oi/oi-for-home-improvement-decisions" },
    ...
    <main className="mx-auto max-w-5xl px-6 py-12">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-bold tracking-tight">Optimized Intelligence for Home Improvement Decisions</h1>
          <p className="mt-3 text-white/75 max-w-3xl">Make better home improvement decisions using Optimized Intelligence (OI) to avoid costly mistakes and manage projects systematically.</p>
        </div>
