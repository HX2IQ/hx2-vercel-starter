...
export const metadata: Metadata = {
    alternates: { canonical: "/oi/oi-verification-rules" },
  openGraph: { url: "https://optinodeiq.com/oi/oi-verification-rules" },
    ...
    <main className="mx-auto max-w-5xl px-6 py-12">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-bold tracking-tight">Optimized Intelligence Verification Rules</h1>
          <p className="mt-3 text-white/75 max-w-3xl">Learn the verification rules that make Optimized Intelligence (OI) reliable, repeatable, and resistant to noise.</p>
        </div>
