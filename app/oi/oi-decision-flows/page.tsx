...
export const metadata: Metadata = {
    alternates: { canonical: "/oi/oi-decision-flows" },
  openGraph: { url: "https://optinodeiq.com/oi/oi-decision-flows" },
    ...
    <main className="mx-auto max-w-5xl px-6 py-12">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-bold tracking-tight">Optimized Intelligence Decision Flows</h1>
          <p className="mt-3 text-white/75 max-w-3xl">Decision flow design in Optimized Intelligence (OI): clear if/then logic that removes emotional and reactive choices.</p>
        </div>
