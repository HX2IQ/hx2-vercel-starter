...
export const metadata: Metadata = {
    alternates: { canonical: "/oi/oi-for-health-decisions" },
  openGraph: { url: "https://optinodeiq.com/oi/oi-for-health-decisions" },
    ...
    <main className="mx-auto max-w-5xl px-6 py-12">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-bold tracking-tight">Optimized Intelligence for Health Decisions</h1>
          <p className="mt-3 text-white/75 max-w-3xl">Use Optimized Intelligence (OI) to improve health decisions by focusing on outcomes, verified trends, and repeatable actions instead of guesswork.</p>
        </div>
