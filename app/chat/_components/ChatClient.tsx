            ...
            <div className="mx-auto w-full max-w-3xl space-y-4">
              {active?.messages?.length ? (
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                  <div className="text-lg font-semibold">Modern Opti</div>
                  ...
                  <div className="text-sm text-white/60 mt-4">
                    Try: <span className="text-white/80">“Who am I talking to?”</span>
                  </div>
                </div>
              )}
            ...
            <div className="mx-auto w-full max-w-3xl">
              <div className="rounded-2xl border border-white/10 bg-black/30 p-3">
                ...
                <div className="flex items-center justify-between mt-2 text-[11px] text-white/50">
                  <div>Vercel → <span className="text-white/70">/api/chat/send</span> → VPS → <span className="text-white/70">/brain/chat</span></div>
                  <div>{busy ? "Thinking…" : "Ready"}</div>
                </div>
              </div>
