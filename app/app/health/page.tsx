...
export default function Page() {
  ...
  const [payloadText, setPayloadText] = useState(JSON.stringify({"labelText":"Ingredients: water, ...","notes":"compare to RX bar"}, null, 2));
  const [busy, setBusy] = useState(false);
  const [result, setResult] = useState<any>(null);

  const taskType = "health.score";
  ...
  return (
    <main style={{ maxWidth: 980, margin: "0 auto", padding: 16, fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, Arial" }}>
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"baseline", gap:12 }}>
        <h1 style={{ fontSize: 28, fontWeight: 900, marginBottom: 6 }}>Health</h1>
