...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    route:
      "/api/hx2/phase7-execution-replay",

    mode:
      "read_only_phase7_execution_replay",

    mutation_allowed: false,

    orchestration_stage:
      "phase7_execution_replay",
    ...
    capability:
      "execution_replay_engine_contract",

    contract_domain:
      "execution_trace_replay_contracts",
